        ...
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="list-group list-group-flush">
                    ...
                    <ul class="main-menu">
                        <li class="link"><a href="<?php echo base_url();?>control_admin/c_admin">Dashboard</a></li>
                        <li class="link"><a href="<?php echo base_url();?>control_admin/c_admin/data">Daftar Koleksi</a></li>
                        <li class="link"><a href="<?php echo base_url();?>control_admin/c_admin/jahitan">Daftar Jahitan</a></li>
                        <li class="link"><a href="<?php echo base_url();?>control_admin/c_admin/transaksi">Daftar Transaksi</a></li>
                    </ul>
                </div>
            </nav>
        </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    ?>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <!-- <a class="dropdown-item" href="#">Info Admin</a> -->
                    ...
                    ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url();?>c_login"><div class="login">Login</div></a>
                        </li>
                    <?php
                    }
                    ?>
