        ...
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="list-group list-group-flush">
                    ...
                    <ul class="main-menu">
                        <div class="menu"><h4>Main Menu</h4></div>
                        <li class="link"><a href="<?php echo base_url();?>c_user">Home</a></li>
                        <li class="link"><a href="<?php echo base_url();?>c_user/koleksi">Koleksi Pakaian</a></li>
                        <li class="link"><a href="<?php echo base_url();?>c_user/carapesan">Cara Pemesanan</a></li>
                        <li class="link"><a href="<?php echo base_url();?>c_user/caraukur">Cara Pengukuran</a></li>
                    </ul>
                </div>
            </nav>
        </div>
